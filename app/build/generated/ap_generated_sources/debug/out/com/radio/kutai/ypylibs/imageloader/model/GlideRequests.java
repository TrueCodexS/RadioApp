package com.radio.kutai.ypylibs.imageloader.model;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.radio.kutai.ypylibs.imageloader.model.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.radio.kutai.ypylibs.imageloader.model.GlideOptions().apply(toSet));
    }
  }
}
